@props(['title','searchDisplay'=>"d-block",'buttonIcon'=>"",'btnText1'=>"Create",'btnText2'=>"",'filterDisplay'=>"d-block",'iconBar'=>"d-block",'btnRoute'=>""])
<header class="py-2 container-fluid bg-white" style="border-bottom: 1px solid rgb(177, 177, 177) !important; height:90px !important">
    <div class="row">
        ...
        <!--search bar-->
        <x-layouts.header_part.searchbar searchDisplay="{{ $searchDisplay }}"/>
