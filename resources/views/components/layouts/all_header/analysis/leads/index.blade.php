        ...
        <div class="col-xl-6 d-flex justify-content-between">
           ...
           <div class="btn-group justify-content-md-start">
            ...
            <div class="dropdown my-1 ">
                ...
                <a href="#" class="btn legitRipple btn-sm px-1 " data-toggle="dropdown" aria-expanded="true" style="padding-top:3px;padding-bottom:3px "><i class="icon-paragraph-justify3 mr-1 "style="font-size: 0.73em;"></i><span style="font-size: 1em;" class="text-capitalize">Comparision</span></a>
                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
