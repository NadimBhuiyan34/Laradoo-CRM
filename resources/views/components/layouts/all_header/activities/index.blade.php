    ...
    <div class="row">
        ...
        <div class="col-xl-6 justify-content-md-start" id="data-table-header">
            <div class="py-0">
               ...
               <a href="{{route('activities-create') }}"> <button type="button" class="btn btn-success btn-sm legitRipple rounded" style="background-color:hsl(126, 95%, 23%); color: white; padding:3px 10px 3px 10px">Create</button></a>
