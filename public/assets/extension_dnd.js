...
var DragAndDrop = function() {
    ...
    var _componentDragula = function() {
        ...
        // Draggable cards
        dragula([
            document.getElementById('cards-target-1'), 
            document.getElementById('cards-target-2'),
            document.getElementById('cards-target-3'),
            document.getElementById('cards-target-4')
        ]);
